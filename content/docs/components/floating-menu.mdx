---
title: Floating Menu
description: Beautiful, animated and totally accessible floating menu
---
...
This menu uses the [Magnet](./magnet.mdx) component, so make sure to copy it.

Copy and paste the following code into your project.
```tsx title="floating-menu.tsx"
"use client";
